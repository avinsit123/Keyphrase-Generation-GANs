...
#    print("Test 1 Passed")
    ...
    avg_batch_loss = ( abstract_loss_real + abstract_loss_fake )/opt.batch_size 
    avg_real = real_rewards / batch_size
    avg_fake = fake_rewards / batch_size
...
#
            ...
            if batch_i%350==0:
                ...
                state_dfs = D_model.state_dict()
                torch.save(state_dfs,"Discriminator_checkpts/elbis_Dis_" + str(epoch) + ".pth.tar")
