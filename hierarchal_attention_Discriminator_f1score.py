...
def train_one_batch(D_model,one2many_batch, generator, opt,perturb_std):
    ...
    real_rewards,_,_ = D_model.calculate_context(abstract_t,kph_t,1,len_list_t)  
    fake_rewards,_,_  = D_model.calculate_context(abstract_f,kph_f,0,len_list_f)  
...
def main():
  ...
  #  model.load_state_dict(torch.load("RL_Checkpoints/hierarchal_Dis.pth.tar"))
    ...
    ### PLEASE PASTE YOUR CHECKPOINT PATH HERE ###
