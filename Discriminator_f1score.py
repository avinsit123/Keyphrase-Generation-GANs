...
#    
        ...
        reshaped_rewards = generate_rewards(D_model,src_list,trg_str_list,total_len)
 
        print(reshaped_rewards.size())
...
def main():
    ...
    D_model.load_state_dict(torch.load("Checkpoint_1.pth.tar"))
    ...
    for epoch in range(total_epochs):
        ...
        for batch_i, batch in enumerate(valid_data_loader):
            ...
            if batch_i%100==0:
                ...
                torch.save(state_dfs,"Checkpoint_softmax12" + str(epoch) + ".pth.tar")
